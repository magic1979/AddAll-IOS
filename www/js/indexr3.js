...
var app = {
    ...
    receivedEvent: function(id) {
		 ...
		 //DATA
		  ...
		  $("#imgutente2").attr("src","http://msop.it/public/addall/"+localStorage.getItem("foto")+"");
			...
			$("#migliori2017").html("<b>I MIGLIORI DEL 2017</b>")
			 ...
			 $.ajax({
			 type:"GET",
			 url:"http://msop.it/addall/leggipuntiTOT.php?email="+localStorage.getItem("email")+"&rnd=3",
		...
		function ris1week(){
			...
			$.ajax({
				   type:"GET",
				   url:"http://msop.it/addall/leggipuntiDay.php?email="+localStorage.getItem("email")+"&rnd=3",
				   contentType: "application/json",
				   //data: {Lat:3,Longi:4},
				   timeout: 7000,
				   jsonp: 'callback',
